...
{
	?>
<img src="<?php echo plugins_url('elements/',__FILE__); ?>images/<?php echo  $img_group_id; ?>/<?php echo  $a[$i]; ?>.png" id="<?php echo  $a[$i]; ?>" alt="<?php if($a[$i]=='plus') echo 'Zoom in'; if($a[$i]=='minus') echo 'Zoom out';  if($a[$i]=='100') echo 'Regular';?>" style="display:<?php if($but_pos) echo "inline"; else echo "block"; ?>;cursor:pointer;" onclick="<?php echo  $func[$a[$i]]; ?> "/>
	<?php
